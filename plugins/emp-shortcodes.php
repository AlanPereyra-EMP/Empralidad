  	...
  	$tbody = [];
    	...
    	if($st[2]&&$nd[2]&&$rd[2]){
	    	...
	    	$tbody['links'] = '<tr class="sfpo-links">
						    		...
						    		'<td><a class="shadow-grey-down btn" href="'.$link0.'">'.$link_name0.'</a></td>'.
                    '<td><a class="shadow-grey-down btn" href="'.$link1.'">'.$link_name1.'</a></td>'.
						    		'<td><a class="shadow-grey-down btn" href="'.$link2.'">'.$link_name2.'</a></td>
					    		</tr>';
		}
