...
// 10) Pixel facebook
	...
	function informatica_pereyra_customize_register($wp_customize){
		...
		// 1) Img
			...
			// end slide1
			// Slide2
				$wp_customize->add_section('ip_section_slide2', array(
					'title'=> __('Imagen principal 2', 'informatica_pereyra'),
					'priority' => 3,
					'panel' => 'ip_panel_img'
				));
				// Img 2
					$wp_customize->add_setting('ip_img_slide2', array(
						'trasnport' => 'refresh',
						'sanitize_callback' => 'sanitize_string',
						
					));

					$wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'ip_img_slide2_control', array(
						'label'=> __('Imagen destacada', 'informatica_pereyra'),
		...
		// 3) Homepage texts
			// Add panel
				$wp_customize->add_panel( 'ip_panel_home_text', array(
					'priority' => 3,
					'title' => __( 'Secciones destacadas homepage', 'informatica_pereyra' )
				));
			// end add panel
			// Home text 1
		...
		// 6) Mobile buttons
			...
			// Home button
				$wp_customize->add_setting('ip_mobile_home_text', array(
					'default' => '',
					'trasnport' => 'refresh',
					'sanitize_callback' => 'sanitize_encoded'
				));

				$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'ip_mobile_home_text_control', array(
					'label'=> __('Inicio', 'informatica_pereyra'),
					'section'=> 'ip_section_mobile',
					'settings'=> 'ip_mobile_home_text',
				)));
			// end home button
			// User button
