      ...
      .disable-scroll{
        ...
        ?>
            <header id="carouselExampleFade" class="carousel slide carousel-fade">
                ...
                <i class="fas fa-caret-down button-down-home" onclick="enableScroll();"></i>
            </header>
        <?php } else {?>
            <!-- Title no img -->
            ...
            <?php if (class_exists('WooCommerce')){ ?>
              <div class="p-2">
                    ...
                    if($featured_products === 'true') { ?>
                        <h2 class="pt-5 pb-4 widget-title-dark text-center display-4"><?php echo get_theme_mod('ip_woocommerce_featured_title'); ?></h2>
