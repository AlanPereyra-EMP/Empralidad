                    ...
                    <div class="container-fluid my-auto text-homepage-container">
                      <div id="carouselFade" class="carousel carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                          ...
                          <div class="carousel-item active empFadeIn mx-auto color-personalized" style="max-width:85%;">
                          ...
                          <?php if($emp_show_2 == 'true'){ ?>
                            <div class="carousel-item empFadeIn mx-auto color-personalized" style="max-width:85%;">
                ...
                <!-- Text 1 -->
                    ...
                    if ($emp_homepage_show == 'true'){
                        ...
                        <div class="py-3 col-12 col-md-4 mx-auto my-auto bg-personalized border-30px" >
                            ...
                            <img class="aligncenter no-shadow wp-image-10 <?php if(!$logo){ ?> no-shadow <?php } ?> " src="<?php echo wp_get_attachment_url(get_theme_mod('emp_head_logo')); ?>" alt="" width="20" height="20" />
                            <p class="p-2 mw-100 text-<?php echo get_theme_mod('emp_homepage_text_aling1'); ?> " >
                                <?php if($img){ ?> <img src="<?php echo wp_get_attachment_url(get_theme_mod('emp_homepage_img1')); ?>" class="img-fluid no-shadow"> <?php } ?> <br>
                                <?php echo get_theme_mod('emp_homepage_text1') ?>
                            </p>
