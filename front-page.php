    ...
    <div id="first-content-home" class="<?php if( is_admin_bar_showing() ){ ?> admin-bar-show <?php } ?> bg-personalized"></div>
        ...
        <!-- The content -->
            <div class="row mw-100 mx-auto">
                <div class="col-12 col-md-3 mx-auto px-0 bg-personalized show-from-md left-featured-text <?php if( is_admin_bar_showing() ){ ?> left-featured-text-admin <?php } ?>">
                    <!-- Text 1 -->
                        <?php $ip_homepage_show = get_theme_mod('ip_homepage_show1');
                        $logo = get_theme_mod('ip_img_logo');
                ...
                <?php } else { ?> 
                    ...
                    <article class="pt-5 p-3 col-12 <?php if($ip_show1||$ip_show2||$ip_show3){ ?> col-md-9 <?php }else{ ?> col-md-10 col-lg-9 <?php } ?> mx-auto">
