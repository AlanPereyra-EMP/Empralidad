...
<article class="p-md-4 content-background content-color woo-page-margin" style="">
  ...
  <div class="sidebar">
    ...
    <div class="show-desktop">
      ...
      <input id="emp-range-price-desktop" class="emp-range-price mb-3" type="range" min="<?php echo $lowest_price; ?>" max="<?php echo $highest_price; ?>" step="1" onchange="window.location.href = 'http://localhost/wordpress/tienda/?max_price='+this.value">
  ...
  <div class="sidebar-mobile show-mobile py-5 px-3">
    ...
    <input id="emp-range-price-mobile" class="emp-range-price mb-3" type="range" min="<?php echo $lowest_price; ?>" max="<?php echo $highest_price; ?>" step="1" onchange="window.location.href = 'http://localhost/wordpress/tienda/?max_price='+this.value">
    <p class="px-0 pb-0">Filtrar por nombre</p>
