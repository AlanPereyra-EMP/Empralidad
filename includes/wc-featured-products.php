...
<?php if($featured_products === 'true' && class_exists('WooCommerce')) { ?>
  <div class="p-2">
            ...
            <h2 class="pt-5 pb-4 px-0 h1 text-center"><?php echo get_theme_mod('ip_woocommerce_featured_title'); ?></h2>
            <p class="py-2 text-center"><small><?php echo get_theme_mod('ip_woocommerce_featured_text'); ?></small></p>
            <div id="woo_featured_products" class="px-1 py-4 col-12 mx-auto text-center" style="overflow-x:auto;">
