<section class="card p-0 to-fadein-animation border-30px">
  ...
  <div class="card-block">
    <a href="<?php the_permalink(); ?>"><button class="card-button btn container-fluid alingcenter mt-auto my-5">Comentarios</button></a>
  </div>
